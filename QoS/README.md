...
I uploaded my current settings of QoS, it's working like that over 2 weeks and no issues at all even during heavy load of network. `Buckets=2048`, default `Flow=1024`, so if you set `Flow=2048` then set also `Buckets=4096`.
